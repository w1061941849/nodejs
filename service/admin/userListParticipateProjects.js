...
exports.showHtml = function (req, res, next) {   
	...
	async.waterfall([
	    function (done) {
	    	var options={
		        "path":'/userParticipateProjects/'+req.params.page+"?userid="+req.query.userid + (status ? "&status="+status : "")
		    }   
		    console.log(options)
    ...
    function(err, results) { 
    	...
    	res.render('admin/userListParticipateProjects',{'results':resultData}) 	
    });   
};  
